...
def main():
    ...
    for name in ['low_resolution64x64', 'low_resolution200x200400', 'low_resolution400x400']:
        video_path = 'demo/bear/' + name
        save_path =  'demo/bear_results/' + name
        ...
        model.load_state_dict(torch.load('experiments/pretrained_models/IART_REDS_BI_N16.pth')['params'], strict=False)
